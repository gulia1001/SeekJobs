...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Groq LLM enrichment pipeline for job vacancies")
    ...
    parser.add_argument("--cheap-model", default="llama-3.1-8b-instant", help="Cheap Groq model for mass extraction")
    parser.add_argument("--fallback-model", default="llama-3.3-70b-versatile", help="Fallback Groq model for retries")
